...
export const QUIZ_STEPS: QuizStep[] = [
  {
    ...
    hudPhrase: "PERSONAL TRAINER DIAGNOSTIC",
    options: [
      {
        value: "burn",
  ...
  },
  {
    ...
    titleHighlight: "drives you?",
    heroPhoto: "/quiz/vision-hero-flex-back.png",
    subtitle: "Choose what motivates you the most right now.",
    hudPhrase: "MOTIVATION PROFILE SCAN",
    reassurance: {
      title: "Your why is your fuel.",
      body: "We'll build a plan that keeps you motivated every step of the way.",
    },
    options: [
      {
        value: "confident",
        ...
        icon: "sparkles",
        image: "/quiz/vision-feel-confident.png",
      },
      {
        value: "strong",
        label: "Feel strong",
        ...
        icon: "dumbbell",
        image: "/quiz/vision-feel-strong.png",
      },
      {
        value: "energised",
        ...
        icon: "zap",
        image: "/quiz/vision-more-energy.png",
      },
      {
        value: "proud",
        ...
        icon: "trophy",
        image: "/quiz/vision-prove-it.png",
      },
    ],
  },
  {
    ...
    title: "Still avoiding mirrors?",
    subtitle: "Nobody's coming to fix that for you. Might as well be you.",
    hudPhrase: "ZERO-EXCUSE PROTOCOL",
    buttonLabel: "FINE. NO MORE EXCUSES 🔥",
