...
const TIERS: {
...
}[] = [
  {
    ...
    price: "₪0",
    period: "לתמיד",
    description: "כדי להתחיל להפסיק לנחש — מהלך אחד ברור בכל פעם.",
    features: [
      "עסק אחד",
      "צ׳ק-אין שבועי + מהלך אחד ברור",
      "השקיפות המלאה: למה זה המהלך ואיך נדע אם טעינו",
      "מעקב תוצאות בסיסי",
    ],
    cta: "התחילו בחינם",
    highlighted: false,
  ...
  },
  {
    ...
    price: "₪79",
    period: "לחודש",
    description: "למי שרוצה לדעת מה באמת עובד — ולחזור על זה.",
    features: [
      "עד 5 עסקים / מותגים",
      "צ׳ק-אין מתי שרוצים, לא רק פעם בשבוע",
      "‏‎«מה עובד אצלך»‎ — הערוץ החזק, אחוז ההצלחה והמגמות שלך",
      "Track Record מלא של כל ההחלטות והתוצאות",
      "תמיכה מהירה",
    ],
    cta: "שדרגו לפרו",
    highlighted: true,
  ...
  },
  {
    ...
    price: "₪249",
    period: "לחודש",
    description: "לסוכנויות ולמנהלים שאחראים על כמה עסקים במקביל.",
    features: [
      "כל היכולות של פרו",
      "עסקים / מותגים ללא הגבלה",
      "ניהול צוות והרשאות",
      "דוח ביצועים מרוכז לכל העסקים",
